...
soundExplosion  byte CmdWave, NoiseEnd
                ...
                byte CmdFrequencyHigh, 2
                byte CmdFrequencyLow, 163
...
soundSideThrust byte CmdWave, NoiseEnd
                byte CmdAttackDecay, Attack_38ms+Decay_114ms
                byte CmdSustainRelease, Sustain_Vol10+Release_204ms
                byte CmdFrequencyHigh, 16
                byte CmdFrequencyLow, 195
                byte CmdWave, NoiseStart
                byte CmdDelay, 5
                byte CmdWave, NoiseEnd
                byte CmdEnd
soundSideThrustHigh byte >soundSideThrust
soundSideThrustLow  byte <soundSideThrust

; --------------------------------------------------------

soundMainThrust byte CmdWave, NoiseEnd
                byte CmdAttackDecay, Attack_38ms+Decay_114ms
                byte CmdSustainRelease, Sustain_Vol10+Release_204ms
                byte CmdFrequencyHigh, 4
                byte CmdFrequencyLow, 48
                byte CmdWave, NoiseStart
                byte CmdDelay, 5
                byte CmdWave, NoiseEnd
                byte CmdEnd
soundMainThrustHigh byte >soundMainThrust
soundMainThrustLow  byte <soundMainThrust
