...
50 POKE 53287,0 : POKE 53285, 15 : POKE 53286, 11
51 POKE 53273, PEEK(53273) OR 2 : XX = PEEK(53279)
55 FORI=0TO103:READA:POKE12*1024+I,A:NEXT : POKE53272,28
60 FOR I = 0 TO (12*64) : READ A : POKE 11200 + I, A : NEXT I
80 VV = 0 : G = 3/56 : T = 3/56 : HV = 0 : HI = 1/28 : CC = 0
...
216 CD = PEEK(53279) : POKE 53279,0
218 IF (CD AND 1) = 1 THEN 890
220 GOTO 90
...
891 FOR SP = 177 TO 186 : FOR DE = 0 TO 100 :NEXT DE : POKE 2040, SP : NEXT SP
899 GOTO 899
